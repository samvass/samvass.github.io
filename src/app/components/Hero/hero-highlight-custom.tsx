  ...
  return (
    <HeroHighlight>
      <motion.h1
        ...
        className="text-1xl px-4 md:text-4xl lg:text-5xl font-bold text-white max-w-4xl leading-relaxed lg:leading-snug mx-auto"
      >
      <div className="flex flex-col md:flex-row items-center justify-center mx-auto max-w-4xl">
        <div className="text-center md:text-left">
          ...
          <div className="md:text-lg lg:text-2xl text-white leading-relaxed lg:leading-snug mt-2 md:mt-4 ml-4">
